...
def main():
    ...
    Glucose = st.slider('Glucose Level', min_value=40.0, max_value=150.0, value=100)
    BloodPressure = st.slider('Blood Pressure', min_value=10.0, max_value=150.0, value=80)
