...
def main():
    ...
    st.markdown("- **SkinThickness**: Triceps skinfold thickness (mm)")
    ...
    BloodPressure = st.slider('Blood Pressure', min_value=0, max_value=150, value=80)
    SkinThickness = st.slider('Skin Thickness', min_value=0, max_value=100, value=20)
    Insulin = st.slider('Insulin Level', min_value=0, max_value=900, value=30)
    BMI = st.slider('BMI', min_value=0.0, max_value=70.0, value=25.0)
